...
PROCESSED_TRAINING_DATA_PATH = 'datasets/processed_data/processed_training_data.csv'
PROCESSED_TESTING_DATA_PATH = 'datasets/processed_data/processed_testing_data.csv'
# -----------------------------------------------------------------------------
# 3. MODEL ARTIFACTS
# -----------------------------------------------------------------------------
